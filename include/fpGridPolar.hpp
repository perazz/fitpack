...
static_assert(sizeof(fitpack_grid_polar_c) == sizeof(fitpack_fitter_c),
    "C descriptor layout mismatch: fitpack_grid_polar_c vs fitpack_fitter_c");

/**
 * @brief Standalone C++ RAII wrapper for Fortran fitpack_grid_polar
 *
...
public:
    ...
    ~fpGridPolar() override {
        fitpack_grid_polar_c_destroy(as<fitpack_grid_polar_c>(), nullptr);
    }
    ...
    explicit fpGridPolar(fitpack_grid_polar_c& c_wrapper, bool move = false) : fpFitter(NoAlloc{}) {
        if (move) {
            ...
            *as<fitpack_grid_polar_c>() = fitpack_grid_polar_c_null;
            fitpack_grid_polar_c_copy(as<fitpack_grid_polar_c>(), &c_wrapper, false, nullptr);
        }
    }
    ...
    bool is_allocated() const override {
        return as<fitpack_grid_polar_c>()->cptr != nullptr;
    }
    ...
    bool is_pointer() const override {
        return as<fitpack_grid_polar_c>()->is_pointer;
    }

    /**
     * @brief Return the C wrapper struct name for this class (e.g. "fitpack_grid_polar_c").
     */
    const char* c_type_name() const override {
        return fitpack_grid_polar_c_c_type_name(*as<fitpack_grid_polar_c>());
    }
    ...
    fitpack_grid_polar_c& c_handle() {
        return *as<fitpack_grid_polar_c>();
    }
    ...
    virtual void new_points(std::vector<double>& u, std::vector<double>& v, double r, int32_t z_n1, int32_t z_n2, std::vector<double>& z, double* z0 = nullptr) {
        ...
        fitpack_grid_polar_c_new_points(as<fitpack_grid_polar_c>(), n, u.data(), v.data(), r, z_n1, z_n2, z.data(), z0);
    }
    ...
    virtual std::vector<double> eval(std::vector<double>& u, std::vector<double>& v, int32_t* ierr = nullptr) {
        ...
        int32_t n_result = 0;
        fitpack_grid_polar_c_gridded_eval_many(as<fitpack_grid_polar_c>(), n, u.data(), v.data(), ierr, result.data(), &n_result, n * n);
    ...
    int32_t comm_size() const override {
        return fitpack_grid_polar_c_comm_size(as<fitpack_grid_polar_c>());
    }
    ...
    void comm_expand(std::vector<double>& buffer) override {
        int32_t n = static_cast<int32_t>(buffer.size());
        fitpack_grid_polar_c_comm_expand(as<fitpack_grid_polar_c>(), n, buffer.data());
    }


    virtual void write(const char* filename) {
        fitpack_grid_polar_c_write(as<fitpack_grid_polar_c>(), filename);
    }

    double mse() const override {
        return fitpack_grid_polar_c_mse(as<fitpack_grid_polar_c>());
    }

    int32_t core_comm_size() const override {
        return fitpack_grid_polar_c_core_comm_size(as<fitpack_grid_polar_c>());
    }
    ...
    void core_comm_expand(std::vector<double>& buffer) override {
        int32_t n = static_cast<int32_t>(buffer.size());
        fitpack_grid_polar_c_core_comm_expand(as<fitpack_grid_polar_c>(), n, buffer.data());
    }


    void destroy_base() override {
        fitpack_grid_polar_c_destroy_base(as<fitpack_grid_polar_c>());
    }
    ...
    double& r() {
        return *fitpack_grid_polar_c_ref_r(as<fitpack_grid_polar_c>());
    }
    ...
    double& z0() {
        return *fitpack_grid_polar_c_ref_z0(as<fitpack_grid_polar_c>());
    }
    ...
    bool z0_present() const {
        return fitpack_grid_polar_c_get_z0_present(as<fitpack_grid_polar_c>());
    }
    void set_z0_present(bool value) {
        fitpack_grid_polar_c_set_z0_present(as<fitpack_grid_polar_c>(), value);
    }

    bool z0_exact() const {
        return fitpack_grid_polar_c_get_z0_exact(as<fitpack_grid_polar_c>());
    }
    void set_z0_exact(bool value) {
        fitpack_grid_polar_c_set_z0_exact(as<fitpack_grid_polar_c>(), value);
    }

    bool z0_zero_gradient() const {
        return fitpack_grid_polar_c_get_z0_zero_gradient(as<fitpack_grid_polar_c>());
    }
    void set_z0_zero_gradient(bool value) {
        fitpack_grid_polar_c_set_z0_zero_gradient(as<fitpack_grid_polar_c>(), value);
    }

    int32_t& nmax() {
        return *fitpack_grid_polar_c_ref_nmax(as<fitpack_grid_polar_c>());
    }
    ...
    int32_t& bc_continuity_origin() {
        return *fitpack_grid_polar_c_ref_bc_continuity_origin(as<fitpack_grid_polar_c>());
    }
    ...
    int32_t& bc_boundary() {
        return *fitpack_grid_polar_c_ref_bc_boundary(as<fitpack_grid_polar_c>());
    }
...
#endif /* FPGRIDPOLAR_HPP_INCLUDED */
