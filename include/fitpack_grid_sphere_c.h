...
!
!   fitpack_grid_sphere_c.h (module fitpack_gridded_sphere)
 ...
 */
FITPACK_CAPI_EXPORT void fitpack_grid_sphere_c_allocate(fitpack_grid_sphere_c* self, fp_status* status);
 ...
 * @param status Optional error status (NULL = error stop on failure)
 */
FITPACK_CAPI_EXPORT void fitpack_grid_sphere_c_destroy(fitpack_grid_sphere_c* self, fp_status* status);
 ...
 * @param status    Optional error status (NULL = error stop on failure)
 */
FITPACK_CAPI_EXPORT void fitpack_grid_sphere_c_copy(fitpack_grid_sphere_c* self, const fitpack_grid_sphere_c* other, bool deep_copy, fp_status* status);
 ...
 * @param status Optional error status (NULL = error stop on failure)
 */
FITPACK_CAPI_EXPORT void fitpack_grid_sphere_c_associate(fitpack_grid_sphere_c* self, const fitpack_grid_sphere_c* other, fp_status* status);
 ...
 * @param status Optional error status (NULL = error stop on failure)
 */
FITPACK_CAPI_EXPORT void fitpack_grid_sphere_c_move_alloc(fitpack_grid_sphere_c* to, fitpack_grid_sphere_c* from, fp_status* status);
 ...
 * @return Result value
 */
FITPACK_CAPI_EXPORT int32_t fitpack_grid_sphere_c_fit(fitpack_grid_sphere_c* self, double* smoothing, bool* keep_knots);
 ...
 * @return Result value
 */
FITPACK_CAPI_EXPORT int32_t fitpack_grid_sphere_c_least_squares(fitpack_grid_sphere_c* self, double* smoothing, bool* reset_knots);
 ...
 * @return Result value
 */
FITPACK_CAPI_EXPORT int32_t fitpack_grid_sphere_c_interpolate(fitpack_grid_sphere_c* self, bool* reset_knots);
 ...
 * @return Result value
 */
FITPACK_CAPI_EXPORT double fitpack_grid_sphere_c_gridded_eval_one(fitpack_grid_sphere_c* self, double u, double v, int32_t* ierr);
 ...
 * @return Result value
 */
FITPACK_CAPI_EXPORT int32_t fitpack_grid_sphere_c_new_fit(fitpack_grid_sphere_c* self, int32_t n, const double* u, const double* v, int32_t z_n1, int32_t z_n2, const double* z, double* smoothing);
 ...
 * @param buffer 
 */
FITPACK_CAPI_EXPORT void fitpack_grid_sphere_c_comm_pack(const fitpack_grid_sphere_c* self, int32_t n, double* buffer);
 ...
 * @param buffer 
 */
FITPACK_CAPI_EXPORT void fitpack_grid_sphere_c_core_comm_pack(const fitpack_grid_sphere_c* self, int32_t n, double* buffer);
