...
public:
     ...
     */
    fpPolar(const fpPolar& other) : fpFitter(NoAlloc{}) {
     ...
     */
    fpPolar(fpPolar&& other) noexcept : fpFitter(NoAlloc{}) {
        *as<fitpack_polar_c>() = fitpack_polar_c_null;
     ...
     */
    explicit fpPolar(fitpack_polar_c& c_wrapper, bool move = false) : fpFitter(NoAlloc{}) {
        if (move) {
     ...
     */
    explicit fpPolar(fitpack_polar_c& c_wrapper, ViewTag) : fpFitter(NoAlloc{}) {
...
protected:
    explicit fpPolar(NoAlloc tag) : fpFitter(tag) {}
