...
!
!   fitpack_gridded_spline_c.h (module fitpack_gridded_splines)
 ...
 */
FITPACK_CAPI_EXPORT void fitpack_gridded_spline_c_allocate(fitpack_gridded_spline_c* self, fp_status* status);
 ...
 * @param status Optional error status (NULL = error stop on failure)
 */
FITPACK_CAPI_EXPORT void fitpack_gridded_spline_c_destroy(fitpack_gridded_spline_c* self, fp_status* status);
 ...
 * @param status    Optional error status (NULL = error stop on failure)
 */
FITPACK_CAPI_EXPORT void fitpack_gridded_spline_c_copy(fitpack_gridded_spline_c* self, const fitpack_gridded_spline_c* other, bool deep_copy, fp_status* status);
 ...
 * @param status Optional error status (NULL = error stop on failure)
 */
FITPACK_CAPI_EXPORT void fitpack_gridded_spline_c_associate(fitpack_gridded_spline_c* self, const fitpack_gridded_spline_c* other, fp_status* status);
 ...
 * @param status Optional error status (NULL = error stop on failure)
 */
FITPACK_CAPI_EXPORT void fitpack_gridded_spline_c_move_alloc(fitpack_gridded_spline_c* to, fitpack_gridded_spline_c* from, fp_status* status);
 ...
 * @return Result value
 */
FITPACK_CAPI_EXPORT int32_t fitpack_gridded_spline_c_fit(fitpack_gridded_spline_c* self, double* smoothing, int32_t* order);
 ...
 * @return Result value
 */
FITPACK_CAPI_EXPORT int32_t fitpack_gridded_spline_c_least_squares(fitpack_gridded_spline_c* self, double* smoothing, bool* reset_knots);

/**
 * @brief interpolate
 * @return Result value
 */
FITPACK_CAPI_EXPORT int32_t fitpack_gridded_spline_c_interpolate(fitpack_gridded_spline_c* self);
 ...
 * @param ierr 
 */
FITPACK_CAPI_EXPORT void fitpack_gridded_spline_c_cross_section(const fitpack_gridded_spline_c* self, int32_t ax, double u, int32_t* ierr, fitpack_gridded_spline_c* result);
 ...
 * @return Result value
 */
FITPACK_CAPI_EXPORT int32_t fitpack_gridded_spline_c_new_fit(fitpack_gridded_spline_c* self, int32_t xg_n1, int32_t xg_n2, const double* xg, int32_t n_z, const double* z, int32_t n, int32_t* m, bool* row_major, int32_t* order, double* smoothing);
 ...
 */
FITPACK_CAPI_EXPORT void fitpack_gridded_spline_c_grid_eval_many(const fitpack_gridded_spline_c* self, int32_t xp_n1, int32_t xp_n2, const double* xp, int32_t* ierr, double* result, int32_t* n_result, int32_t max_size);
 ...
 * @return Result value
 */
FITPACK_CAPI_EXPORT double fitpack_gridded_spline_c_grid_derivatives_one(fitpack_gridded_spline_c* self, int32_t n, const double* x, const int32_t* nu, int32_t* ierr);
 ...
 * @param ierr 
 */
FITPACK_CAPI_EXPORT void fitpack_gridded_spline_c_derivative_spline(const fitpack_gridded_spline_c* self, int32_t n, const int32_t* nu, int32_t* ierr, fitpack_gridded_spline_c* result);

/**
 * @brief comm_pack
 * @param buffer 
 */
FITPACK_CAPI_EXPORT void fitpack_gridded_spline_c_comm_pack(const fitpack_gridded_spline_c* self, int32_t n, double* buffer);
 ...
 * @param buffer 
 */
FITPACK_CAPI_EXPORT void fitpack_gridded_spline_c_core_comm_pack(const fitpack_gridded_spline_c* self, int32_t n, double* buffer);
