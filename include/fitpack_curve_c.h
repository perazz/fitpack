 ...
 */
FITPACK_CAPI_EXPORT void fitpack_curve_c_allocate(fitpack_curve_c* self, fx_status* status);
 ...
 * @param status Optional error status (NULL = error stop on failure)
 */
FITPACK_CAPI_EXPORT void fitpack_curve_c_destroy(fitpack_curve_c* self, fx_status* status);
 ...
 * @param status    Optional error status (NULL = error stop on failure)
 */
FITPACK_CAPI_EXPORT void fitpack_curve_c_copy(fitpack_curve_c* self, const fitpack_curve_c* other, bool deep_copy, fx_status* status);
 ...
 * @param status Optional error status (NULL = error stop on failure)
 */
FITPACK_CAPI_EXPORT void fitpack_curve_c_associate(fitpack_curve_c* self, const fitpack_curve_c* other, fx_status* status);
 ...
 * @param status Optional error status (NULL = error stop on failure)
 */
FITPACK_CAPI_EXPORT void fitpack_curve_c_move_alloc(fitpack_curve_c* to, fitpack_curve_c* from, fx_status* status);
 ...
 * @return Result value
 */
FITPACK_CAPI_EXPORT int32_t fitpack_curve_c_fit(const fitpack_curve_c* self, double* smoothing, int32_t* order, bool* keep_knots);
 ...
 * @return Result value
 */
FITPACK_CAPI_EXPORT int32_t fitpack_curve_c_interpolate(const fitpack_curve_c* self, int32_t* order, bool* reset_knots);
 ...
 * @return Result value
 */
FITPACK_CAPI_EXPORT int32_t fitpack_curve_c_least_squares(const fitpack_curve_c* self, double* smoothing, bool* reset_knots);
 ...
 * @return Result value
 */
FITPACK_CAPI_EXPORT double fitpack_curve_c_curve_eval_one(const fitpack_curve_c* self, double x, int32_t* ierr);
 ...
 * @return Result value
 */
FITPACK_CAPI_EXPORT double fitpack_curve_c_integral(const fitpack_curve_c* self, double from, double to);
 ...
 * @return Result value
 */
FITPACK_CAPI_EXPORT double fitpack_curve_c_curve_derivative(const fitpack_curve_c* self, double x, int32_t order, int32_t* ierr);
 ...
 * @return Result value
 */
FITPACK_CAPI_EXPORT int32_t fitpack_curve_c_new_fit(const fitpack_curve_c* self, int32_t n, const double* x, const double* y, double* w, double* smoothing, int32_t* order);
 ...
 * @note result: caller-allocated buffer of max_size elements; n_result receives the actual count (= product of (SIZE(x)))
 */
FITPACK_CAPI_EXPORT void fitpack_curve_c_curve_eval_many_pure(fitpack_curve_c* self, int32_t n, const double* x, double* result, int32_t* n_result, int32_t max_size);
 ...
 * @param ierr 
 */
FITPACK_CAPI_EXPORT void fitpack_curve_c_zeros(fitpack_curve_c* self, int32_t* ierr, double* result, int32_t* n_result, int32_t max_size);
 ...
 * @note result: caller-allocated buffer of n_result elements; n_result = total element count of ((THIS % ORDER + 1)) — known to the caller from object state / inputs
 */
FITPACK_CAPI_EXPORT void fitpack_curve_c_curve_all_derivatives_pure(fitpack_curve_c* self, double x, double* result, int32_t n_result);
 ...
 * @param buffer 
 */
FITPACK_CAPI_EXPORT void fitpack_curve_c_comm_pack(fitpack_curve_c* self, int32_t n, double* buffer);
 ...
 * @param buffer 
 */
FITPACK_CAPI_EXPORT void fitpack_curve_c_core_comm_pack(fitpack_curve_c* self, int32_t n, double* buffer);
