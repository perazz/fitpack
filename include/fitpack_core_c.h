...
void fp_curfit_c(FP_SIZE iopt, FP_SIZE m, const FP_REAL* x, const FP_REAL* y, const FP_REAL* w,
...
void fp_percur_c(FP_SIZE iopt, FP_SIZE m, const FP_REAL* x, const FP_REAL* y, const FP_REAL* w,
...
void fp_parcur_c(FP_SIZE iopt, FP_SIZE ipar, FP_SIZE idim, FP_SIZE m, FP_REAL* u, FP_SIZE mx,
              const FP_REAL* x,  FP_REAL* w, FP_REAL* ub, FP_REAL* ue, FP_SIZE k,
              FP_REAL* s, FP_SIZE nest, FP_SIZE* n, FP_REAL *t, FP_SIZE nc, FP_REAL* c,
              FP_REAL* fp, FP_REAL *wrk, FP_SIZE lwrk, FP_SIZE *iwrk, FP_FLAG* ier);


void fp_clocur_c(FP_SIZE iopt, FP_SIZE ipar, FP_SIZE idim, FP_SIZE m, FP_REAL* u, FP_SIZE mx,
...
void fp_cocosp_c(FP_SIZE m, const FP_REAL* x, const FP_REAL* y, const FP_REAL* w, FP_SIZE n,
...
void fp_concon_c(FP_SIZE iopt,FP_SIZE m,const FP_REAL* x,const FP_REAL* y,const FP_REAL* w,FP_REAL* v,FP_REAL s,
...
void fp_splev_c(const FP_REAL* t, FP_SIZE n, const FP_REAL* c, FP_SIZE k, const FP_REAL* x, 
             FP_REAL* y, FP_SIZE m, FP_FLAG e,FP_FLAG* ier);
              
void fp_splder_c(const FP_REAL* t,FP_SIZE n,const FP_REAL* c,FP_SIZE k,FP_SIZE nu,const FP_REAL* x,
              FP_REAL* y, FP_SIZE m, FP_FLAG e, FP_REAL* wrk, FP_FLAG*ier);

void fp_spalde_c(const FP_REAL* t,FP_SIZE n,const FP_REAL* c,FP_SIZE k1,
              FP_REAL x,FP_REAL* d, FP_FLAG* ier);

void fp_curev_c(FP_SIZE idim,const FP_REAL* t,FP_SIZE n, const FP_REAL* c,FP_SIZE nc, FP_SIZE k,
             const FP_REAL* u,FP_SIZE m, FP_REAL* x,FP_SIZE mx, FP_FLAG* ier);

void fp_cualde_c(FP_SIZE idim, const FP_REAL* t,FP_SIZE n,const FP_REAL* c,FP_SIZE nc,FP_SIZE k1, 
              FP_REAL u, FP_REAL* d, FP_SIZE nd, FP_FLAG* ier);
  
void fp_insert_c(FP_SIZE iopt, FP_REAL* t, FP_SIZE* n, FP_REAL* c, FP_SIZE k, FP_REAL x, 
              FP_SIZE nest, FP_FLAG* ier);  
           
FP_REAL fp_splint_c(const FP_REAL* t, FP_SIZE n, const FP_REAL* c, FP_SIZE k, FP_REAL a, 
              FP_REAL b, FP_REAL* wrk);            
    
void fp_fourco_c(const FP_REAL* t, FP_SIZE n, const FP_REAL* c, const FP_REAL* alfa, FP_SIZE m, 
              FP_REAL* ress, FP_REAL* resc, FP_REAL* wrk1, FP_REAL* wrk2, FP_FLAG* ier);    
  
void fp_sproot_c(const FP_REAL* t, FP_SIZE n, const FP_REAL* c, FP_REAL* zeros, FP_SIZE mest, 
              FP_SIZE* m, FP_FLAG* ier);
    
void fp_surfit_c(FP_SIZE iopt, FP_SIZE m, FP_REAL* x, FP_REAL* y, const FP_REAL* z, const FP_REAL* w, 
...
void fp_regrid_c(FP_SIZE iopt, FP_SIZE mx, const FP_REAL* x, 
                            ...
                            FP_FLAG* ier);
void fp_polar_c(const FP_SIZE* iopt, FP_SIZE m, const FP_REAL* x, const FP_REAL* y, const FP_REAL* z,
...
void fp_pogrid_c(const FP_SIZE* iopt, const FP_SIZE* ider, FP_SIZE mu, const FP_REAL* u, FP_SIZE mv, 
...
void fp_sphere_c(FP_SIZE iopt, FP_SIZE m, const FP_REAL* teta, const FP_REAL* phi, const FP_REAL* r,
...
FP_FLAG fp_spgrid_c(const FP_SIZE* iopt, const FP_SIZE* ider,
...
FP_FLAG fp_parsur_c(FP_SIZE iopt, const FP_SIZE* ipar, FP_SIZE idim, FP_SIZE mu, const FP_REAL* u, FP_SIZE mv,
...
FP_FLAG fp_bispeu_c(const FP_REAL* tx, FP_SIZE nx, const FP_REAL* ty, FP_SIZE ny, const FP_REAL* c,
                 FP_SIZE kx, FP_SIZE ky, const FP_REAL* x, const FP_REAL* y, FP_REAL* z,
                 FP_SIZE m, FP_REAL* wrk, FP_SIZE lwrk);
        
FP_FLAG fp_bispev_c(const FP_REAL* tx, FP_SIZE nx, const FP_REAL* ty, FP_SIZE ny, const FP_REAL* c,
...
FP_FLAG fp_parder_c(const FP_REAL* tx, FP_SIZE nx, const FP_REAL* ty, FP_SIZE ny, const FP_REAL* c,
