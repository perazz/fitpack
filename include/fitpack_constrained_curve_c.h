...
!
!   fitpack_constrained_curve_c.h (module fitpack_parametric_curves)
 ...
 */
FITPACK_CAPI_EXPORT void fitpack_constrained_curve_c_allocate(fitpack_constrained_curve_c* self, fp_status* status);
 ...
 * @param status Optional error status (NULL = error stop on failure)
 */
FITPACK_CAPI_EXPORT void fitpack_constrained_curve_c_destroy(fitpack_constrained_curve_c* self, fp_status* status);
 ...
 * @param status    Optional error status (NULL = error stop on failure)
 */
FITPACK_CAPI_EXPORT void fitpack_constrained_curve_c_copy(fitpack_constrained_curve_c* self, const fitpack_constrained_curve_c* other, bool deep_copy, fp_status* status);
 ...
 * @param status Optional error status (NULL = error stop on failure)
 */
FITPACK_CAPI_EXPORT void fitpack_constrained_curve_c_associate(fitpack_constrained_curve_c* self, const fitpack_constrained_curve_c* other, fp_status* status);
 ...
 * @param status Optional error status (NULL = error stop on failure)
 */
FITPACK_CAPI_EXPORT void fitpack_constrained_curve_c_move_alloc(fitpack_constrained_curve_c* to, fitpack_constrained_curve_c* from, fp_status* status);
 ...
 * @return Result value
 */
FITPACK_CAPI_EXPORT int32_t fitpack_constrained_curve_c_fit(fitpack_constrained_curve_c* self, double* smoothing, int32_t* order, bool* keep_knots);
 ...
 * @return Result value
 */
FITPACK_CAPI_EXPORT int32_t fitpack_constrained_curve_c_interpolate(fitpack_constrained_curve_c* self, int32_t* order, bool* reset_knots);
 ...
 * @return Result value
 */
FITPACK_CAPI_EXPORT int32_t fitpack_constrained_curve_c_least_squares(fitpack_constrained_curve_c* self, double* smoothing, bool* reset_knots);
 ...
 * @param buffer 
 */
FITPACK_CAPI_EXPORT void fitpack_constrained_curve_c_comm_pack(const fitpack_constrained_curve_c* self, int32_t n, double* buffer);
 ...
 * @return Result value
 */
FITPACK_CAPI_EXPORT int32_t fitpack_constrained_curve_c_new_fit(fitpack_constrained_curve_c* self, int32_t x_n1, int32_t x_n2, const double* x, double* u, double* w, double* smoothing, int32_t* order);
 ...
 * @param buffer 
 */
FITPACK_CAPI_EXPORT void fitpack_constrained_curve_c_core_comm_pack(const fitpack_constrained_curve_c* self, int32_t n, double* buffer);
