...
!
!   fitpack_grid_surface_c.h (module fitpack_gridded_surfaces)
 ...
 */
FITPACK_CAPI_EXPORT void fitpack_grid_surface_c_allocate(fitpack_grid_surface_c* self, fp_status* status);
 ...
 * @param status Optional error status (NULL = error stop on failure)
 */
FITPACK_CAPI_EXPORT void fitpack_grid_surface_c_destroy(fitpack_grid_surface_c* self, fp_status* status);
 ...
 * @param status    Optional error status (NULL = error stop on failure)
 */
FITPACK_CAPI_EXPORT void fitpack_grid_surface_c_copy(fitpack_grid_surface_c* self, const fitpack_grid_surface_c* other, bool deep_copy, fp_status* status);
 ...
 * @param status Optional error status (NULL = error stop on failure)
 */
FITPACK_CAPI_EXPORT void fitpack_grid_surface_c_associate(fitpack_grid_surface_c* self, const fitpack_grid_surface_c* other, fp_status* status);
 ...
 * @param status Optional error status (NULL = error stop on failure)
 */
FITPACK_CAPI_EXPORT void fitpack_grid_surface_c_move_alloc(fitpack_grid_surface_c* to, fitpack_grid_surface_c* from, fp_status* status);
 ...
 * @return Result value
 */
FITPACK_CAPI_EXPORT int32_t fitpack_grid_surface_c_fit(fitpack_grid_surface_c* self, double* smoothing, int32_t* order, bool* keep_knots);
 ...
 * @return Result value
 */
FITPACK_CAPI_EXPORT int32_t fitpack_grid_surface_c_least_squares(fitpack_grid_surface_c* self, double* smoothing, bool* reset_knots);
 ...
 * @return Result value
 */
FITPACK_CAPI_EXPORT int32_t fitpack_grid_surface_c_interpolate(fitpack_grid_surface_c* self, bool* reset_knots);
 ...
 * @return Result value
 */
FITPACK_CAPI_EXPORT double fitpack_grid_surface_c_gridsurf_eval_one(fitpack_grid_surface_c* self, double x, double y, int32_t* ierr);
 ...
 * @return Result value
 */
FITPACK_CAPI_EXPORT double fitpack_grid_surface_c_gridded_eval_one(fitpack_grid_surface_c* self, double x, double y, int32_t* ierr);
 ...
 * @return Result value
 */
FITPACK_CAPI_EXPORT double fitpack_grid_surface_c_gridded_derivatives_one(fitpack_grid_surface_c* self, double x, double y, int32_t dx, int32_t dy, int32_t* ierr);
 ...
 * @param ierr 
 */
FITPACK_CAPI_EXPORT void fitpack_grid_surface_c_cross_section(const fitpack_grid_surface_c* self, double u, bool along_y, int32_t* ierr, fitpack_curve_c* result);
 ...
 * @param ierr 
 */
FITPACK_CAPI_EXPORT void fitpack_grid_surface_c_derivative_spline(const fitpack_grid_surface_c* self, int32_t nux, int32_t nuy, int32_t* ierr, fitpack_grid_surface_c* result);
 ...
 * @return Result value
 */
FITPACK_CAPI_EXPORT int32_t fitpack_grid_surface_c_new_fit(fitpack_grid_surface_c* self, int32_t n, const double* x, const double* y, int32_t z_n1, int32_t z_n2, const double* z, double* smoothing, int32_t* order);
 ...
 * @param buffer 
 */
FITPACK_CAPI_EXPORT void fitpack_grid_surface_c_comm_pack(const fitpack_grid_surface_c* self, int32_t n, double* buffer);
 ...
 * @param buffer 
 */
FITPACK_CAPI_EXPORT void fitpack_grid_surface_c_core_comm_pack(const fitpack_grid_surface_c* self, int32_t n, double* buffer);
